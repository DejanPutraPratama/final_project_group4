                    ...
                    onPressed: () {
                      setState(() {
                        if (_email.text.isEmpty) {
                          _resetEmailError = 'Email have not been registered';
                        } else {
                ...
                children: [
                  ...
                  const SizedBox(height: 16),
                    ...
                    onPressed: () {
                      setState(() {
                        if (_email.text.isEmpty) {
                          _passwordError2 = 'Confirm password is not same with the password';
                        } else {
          ...
          children: <Widget>[
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              InkWell(
                ...
                child: 
                const Text("Forgot password", style: TextStyle(color: Colors.lightGreen)),
              )
            ]),
            ...
            Row(mainAxisAlignment: MainAxisAlignment.center, children: [
              InkWell(
                ...
                child:
                const Text("Don't have an account ? Join us",style: TextStyle(color: Colors.lightGreen),
                )
              )
            ]),
            const Spacer()
